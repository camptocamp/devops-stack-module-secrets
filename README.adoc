...
:external-secrets-chart-version: 0.9.16
:reloader-chart-version: 1.0.83
...
A https://devops-stack.io[DevOps Stack] module to deploy the External Secrets Operator.
...
|*{external-secrets-chart-version}* |{external-secrets-original-repo-url}/tree/main/deploy/charts/external-secrets[Chart] |https://artifacthub.io/packages/helm/external-secrets-operator/external-secrets/{{external-secrets-chart-version}?modal=values[`values.yaml`]
|*{reloader-chart-version}* |{reloader-original-repo-url}tree/master/deployments/kubernetes/chart/reloader[Chart] |https://artifacthub.io/packages/helm/stakater/reloader/{reloader-chart-version}?modal=values[`values.yaml`]
|===
